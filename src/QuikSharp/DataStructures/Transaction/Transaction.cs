...
namespace QuikSharp.DataStructures.Transaction
{
    ...
    // для работы. По факту это иерархия классов - по классу на TransactionAction
    // нужно разбить этого монстра на иерархию классов
    // А лучше сделать DSL в F# и не добавлять торговую логику в этот проект вообще никак - это только коннектор
